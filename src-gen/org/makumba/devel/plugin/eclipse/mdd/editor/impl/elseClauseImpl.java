 ...
 * <ul>
 *   <li>{@link org.makumba.devel.plugin.eclipse.mdd.editor.impl.elseClauseImpl#getU <em>U</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class elseClauseImpl extends MinimalEObjectImpl.Container implements elseClause
{
  ...
  {
    return EditorPackage.Literals.ELSE_CLAUSE;
  }
  ...
  public NotificationChain basicSetU(unaryExpression newU, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditorPackage.ELSE_CLAUSE__U, oldU, newU);
  ...
  public void setU(unaryExpression newU)
  {
    if (newU != u)
    {
      ...
      if (u != null)
        msgs = ((InternalEObject)u).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditorPackage.ELSE_CLAUSE__U, null, msgs);
      if (newU != null)
        msgs = ((InternalEObject)newU).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditorPackage.ELSE_CLAUSE__U, null, msgs);
      msgs = basicSetU(newU, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.ELSE_CLAUSE__U, newU, newU));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EditorPackage.ELSE_CLAUSE__U:
